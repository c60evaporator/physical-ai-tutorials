...
DATA_SAVE_DIR=${DATA_SAVE_DIR:-${DATA_SAVE_ROOT}/${EVAL_ROUTES}_pdmlite_${TIMESTAMP}}
...
export TEAM_AGENT=${TEAM_AGENT:-${CARLA_GARAGE_ROOT}/team_code/autopilot.py}
export TEAM_CONFIG=${TEAM_CONFIG:-${CARLA_GARAGE_ROOT}/team_code/model_ckpt/pdmlite_dummy}
...
export CHALLENGE_TRACK_CODENAME=MAP # MAP for privileged agent evaluation, SENSORS for non-privileged PDM-Lite evaluation
